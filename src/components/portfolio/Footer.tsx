      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 mb-8 text-center">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm mx-auto sm:max-w-none lg:max-w-sm lg:mx-auto">
              WordPress Virtual Assistant & B2B Lead Generation specialist helping businesses grow online since 2016.
            </p>
            <div className="flex gap-2.5 mt-4 justify-center sm:justify-start lg:justify-center">
          ...
          {/* Quick Links - centered on mobile, left on sm+ */}
          <div className="sm:col-span-2 lg:col-span-1">
          ...
          {/* Services - shown on all screens, centered on mobile */}
          <div className="block">
