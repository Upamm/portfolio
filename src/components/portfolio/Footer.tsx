  ...
  return (
    <footer className="relative mt-auto overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <div className="glass-card rounded-2xl p-6 sm:p-10 mb-8 sm:mb-10 text-center relative overflow-hidden">
          ...
          <p className="text-slate-400 text-sm max-w-md mx-auto mb-5 sm:mb-6">
