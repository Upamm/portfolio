  ...
  return (
    <AnimatePresence>
      {showBanner && (
        ...
        >
          <div className="max-w-4xl mx-auto glass-card rounded-2xl p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 shadow-2xl shadow-black/20 border border-teal-500/10">
            {/* Icon */}
