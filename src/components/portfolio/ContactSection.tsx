...
const FIVERR_ICON_URL = 'https://fiverr-res.cloudinary.com/npm-assets/layout-service/favicon-32x32.8f21439.png';
...
const socialLinks = [
  {
    ...
    icon: (
      <img src={FIVERR_ICON_URL} alt="Fiverr" className="w-5 h-5" />
    ),
  },
  {
    name: 'Twitter (X)',
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative pt-20 sm:pt-24 pb-10 sm:pb-16 overflow-hidden">
      {/* Background */}
